...
var z = (o) => new Promise((t, e) => {
  ...
  s.async = true, s.src = o, s.id = "storyblok-javascript-bridge", s.onerror = (r) => e(r), s.onload = (r) => {
    R.forEach((i) => i()), _ = true, t(r);
  }, document.getElementsByTagName("head")[0].appendChild(s);
});
var L = Object.defineProperty;
var U = (o, t, e) => t in o ? L(o, t, { enumerable: true, configurable: true, writable: true, value: e }) : o[t] = e;
var h = (o, t, e) => (U(o, typeof t != "symbol" ? t + "" : t, e), e);
function j(o) {
...
var mt = class {
  ...
  constructor(t, e) {
    if (h(this, "client"), h(this, "maxRetries"), h(this, "throttle"), h(this, "accessToken"), h(this, "cache"), h(this, "helpers"), h(this, "resolveCounter"), h(this, "relations"), h(this, "links"), h(this, "richTextResolver"), h(this, "resolveNestedRelations"), !e) {
      const i = new w().getRegionURL, n = t.https === false ? "http" : "https";
...
var $;
var bt = "https://app.storyblok.com/f/storyblok-v2-latest.js";
var kt = (o, t, e = {}) => {
  var s;
...
var vt = (o = {}) => {
  ...
  return s !== false && u && z(bt), $ = new b(c.schema), c.resolver && P($, c.resolver), l;
};
var P = (o, t) => {
  o.addNode("blok", (e) => {
    let s = "";
