...
var T = (o, e, t) => e in o ? m(o, e, { enumerable: true, configurable: true, writable: true, value: t }) : o[e] = t;
...
var k = class {
  constructor(e) {
    h(this, "marks");
    h(this, "nodes");
    e || (e = V), this.marks = e.marks || [], this.nodes = e.nodes || [];
  }
  addNode(e, t) {
    this.nodes[e] = t;
  }
  ...
  renderNode(e) {
    ...
    }) : e.text ? t.push(j(e.text)) : s && s.singleTag ? t.push(this.renderTag(s.singleTag, " /")) : s && s.html && t.push(s.html), s && s.tag && t.push(this.renderClosingTag(s.tag)), e.marks && e.marks.slice(0).reverse().forEach((r) => {
      const n = this.getMatchingMark(r);
...
var J = class {
  constructor(e) {
    ...
    h(this, "url");
    h(this, "parameters");
    this.baseURL = e.baseURL, this.headers = e.headers || [], this.timeout = e != null && e.timeout ? e.timeout * 1e3 : 0, this.responseInterceptor = e.responseInterceptor, this.fetch = (...t) => e.fetch ? e.fetch(...t) : fetch(...t), this.ejectInterceptor = false, this.url = "", this.parameters = {};
  }
  /**
   *
   * @param url string
...
var Q = class {
  ...
  constructor(e, t) {
    ...
    if (!t) {
      const n = e.region ? `-${e.region}` : "", i = e.https === false ? "http" : "https";
