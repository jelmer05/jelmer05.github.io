...
var A = (c, e, t) => e in c ? b(c, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : c[e] = t;
var u = (c, e, t) => A(c, typeof e != "symbol" ? e + "" : e, t);
...
function T(c, e, t) {
  ...
  return l.abort = () => {
    n = !0, s.forEach(clearTimeout), s = [], i.forEach(
      (a) => a.reject(() => new w("Throttle function aborted"))
    ), i.length = 0;
  }, l;
}
const S = (c = "") => c.includes("/cdn/"), P = (c, e = 25, t = 1) => ({
  ...c,
  per_page: e,
  page: t
}), C = (c) => new Promise((e) => setTimeout(e, c)), $ = (c = 0, e) => Array.from({ length: c }, e), E = (c = 0, e = c) => {
...
class V {
  ...
  constructor(e, t) {
    ...
    if (!i) {
      ...
      e.oauthToken ? i = `${n}://${v(e.region)}/v1` : i = `${n}://${v(e.region)}/v2`;
    }
    const s = new Headers();
    s.set("Content-Type", "application/json"), s.set("Accept", "application/json"), e.headers && (e.headers.constructor.name === "Headers" ? e.headers.entries().toArray() : Object.entries(e.headers)).forEach(([o, l]) => {
      s.set(o, l);
    }), s.has(_) || (s.set(_, g.defaultAgentName), s.set(
      g.defaultAgentVersion,
      g.packageVersion
    ));
    let r = 5;
    e.oauthToken && (s.set("Authorization", e.oauthToken), r = 3), e.rateLimit && (r = e.rateLimit), this.maxRetries = e.maxRetries || 10, this.retriesDelay = 300, this.throttle = T(
      this.throttledRequest.bind(this),
      r,
      1e3
    ), this.accessToken = e.accessToken || "", this.relations = {}, this.links = {}, this.cache = e.cache || { clear: "manual" }, this.resolveCounter = 0, this.resolveNestedRelations = e.resolveNestedRelations || !0, this.stringifiedStoriesCache = {}, this.version = e.version || R.DRAFT, this.inlineAssets = e.inlineAssets || !1, this.client = new N({
      baseURL: i,
      timeout: e.timeout || 0,
      headers: s,
  ...
  factoryParamOptions(e, t) {
    return S(e) ? this.parseParams(t) : t;
  }
    ...
    return new Promise(async (o, l) => {
      ...
      try {
        ...
        if ((a = h.headers) != null && a["per-page"] && (d = Object.assign({}, d, {
          ...
          await this.resolveStories(d.data, t, `${m}`), d = await this.processInlineAssets(d);
        }
...
export {
  _ as STORYBLOK_AGENT,
  g as STORYBLOK_JS_CLIENT_AGENT,
  N as SbFetch,
  R as StoryblokContentVersion,
