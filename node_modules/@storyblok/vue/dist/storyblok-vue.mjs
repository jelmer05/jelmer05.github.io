...
class mt {
  ...
  constructor(t, e) {
    ...
    let r = 5;
    t.oauthToken && (s.set("Authorization", t.oauthToken), r = 3), t.rateLimit && (r = t.rateLimit), t.richTextSchema ? this.richTextResolver = new b(t.richTextSchema) : this.richTextResolver = new b(), t.componentResolver && this.setComponentResolver(t.componentResolver), this.maxRetries = t.maxRetries || 5, this.throttle = q(this.throttledRequest, r, 1e3), this.accessToken = t.accessToken || "", this.relations = {}, this.links = {}, this.cache = t.cache || { clear: "manual" }, this.helpers = new w(), this.resolveCounter = 0, this.resolveNestedRelations = t.resolveNestedRelations || !0, this.client = new ft({
      baseURL: e,
      timeout: t.timeout || 0,
      headers: s,
...
const bt = "https://app.storyblok.com/f/storyblok-v2-latest.js", kt = (o, t, e = {}) => {
  ...
  return s !== !1 && u && z(bt), $ = new b(c.schema), c.resolver && x($, c.resolver), l;
}, x = (o, t) => {
  o.addNode("blok", (e) => {
    let s = "";
    return e.attrs.body.forEach((r) => {
  ...
  return o === "" ? "" : o ? (t && (s = new b(t.schema), t.resolver && x(s, t.resolver)), s.render(o)) : (console.warn(`${o} is not a valid Richtext object. This might be because the value of the richtext field is empty.
  ...
  setup(o) {
    return (t, e) => (E(), I(C(o.blok.component), O(A({ ...t.$props, ...t.$attrs })), null, 16));
  }
}), $t = {
  beforeMount(o, t) {
    if (t.value) {
...
let m = null;
const jt = () => (m || P("useStoryblokApi"), m), xt = async (o, t = {}, e = {}) => {
  const s = M(null);
  if (N(() => {
