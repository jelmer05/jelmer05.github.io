...
function htmlToStoryblokRichtext(html, options = {}) {
	...
	return generateJSON(html, Object.values(finalExtensions), { preserveWhitespace: preserveWhitespace || false });
}

//#endregion
export { htmlToStoryblokRichtext };
