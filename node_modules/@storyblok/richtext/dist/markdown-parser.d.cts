...
declare function markdownToStoryblokRichtext(md: string, options?: MarkdownParserOptions): StoryblokRichTextDocumentNode;
//#endregion
export { MarkdownParserOptions, markdownToStoryblokRichtext };
