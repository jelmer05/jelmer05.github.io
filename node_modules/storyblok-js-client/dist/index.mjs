...
var A = (l, e, t) => e in l ? w(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t;
var c = (l, e, t) => A(l, typeof e != "symbol" ? e + "" : e, t);
...
function P(l, e, t) {
  ...
  return a.abort = () => {
    n = !0, s.forEach(clearTimeout), s = [], r.forEach(
      (h) => h.reject(() => new S("Throttle function aborted"))
    ), r.length = 0;
  }, a;
}
class k {
  ...
  stringify(e, t, r) {
    ...
    for (const i in e) {
      ...
      if (n == null)
        continue;
      const o = r ? "" : encodeURIComponent(i);
      let a;
...
const x = function(l, e) {
  ...
  const e = new k().escapeHTML, t = { ...l.attrs }, { linktype: r = "url" } = l.attrs;
  ...
  optimizeImages(e, t) {
    ...
    return e = e.replace(
      ...
      if (h && h.length > 0) {
        ...
        let y = "";
        return g.srcset && (y += `srcset="${g.srcset}" `), g.sizes && (y += `sizes="${g.sizes}" `), a.replace(/<img/g, `<img ${y.trim()}`);
      }
      return a;
    })), e;
  }
...
class ne {
  ...
  constructor(e, t) {
    ...
    let r = e.endpoint || t;
    if (!r) {
      const n = new k().getRegionURL, o = e.https === !1 ? "http" : "https";
    ...
    let i = 5;
    e.oauthToken && (s.set("Authorization", e.oauthToken), i = 3), e.rateLimit && (i = e.rateLimit), e.richTextSchema ? this.richTextResolver = new $(e.richTextSchema) : this.richTextResolver = new $(), e.componentResolver && this.setComponentResolver(e.componentResolver), this.maxRetries = e.maxRetries || 10, this.retriesDelay = 300, this.throttle = P(
      this.throttledRequest.bind(this),
      i,
      1e3
    ), this.accessToken = e.accessToken || "", this.relations = {}, this.links = {}, this.cache = e.cache || { clear: "manual" }, this.helpers = new k(), this.resolveCounter = 0, this.resolveNestedRelations = e.resolveNestedRelations || !0, this.stringifiedStoriesCache = {}, this.inlineAssets = e.inlineAssets || !1, this.client = new re({
      baseURL: r,
      timeout: e.timeout || 0,
      headers: s,
    ...
    return new Promise(async (o, a) => {
      ...
      try {
        ...
        if ((h = u.headers) != null && h["per-page"] && (f = Object.assign({}, f, {
          ...
          await this.resolveStories(f.data, t, `${y}`), f = await this.processInlineAssets(f);
        }
        ...
        return t.token && f.data.cv && (g && p[t.token] && p[t.token] !== f.data.cv && await this.flushCache(), p[t.token] = f.data.cv), o(f);
      } catch (u) {
