...
class re {
  ...
  optimizeImages(e, t) {
    ...
    return e = e.replace(
      ...
      if (h && h.length > 0) {
        const d = {
          srcset: (u = t.srcset) == null ? void 0 : u.map((g) => {
            if (typeof g == "number")
              return `//${h}/m/${g}x0${n} ${g}w`;
            if (typeof g == "object" && g.length === 2) {
              let b = 0, _ = 0;
              return typeof g[0] == "number" && (b = g[0]), typeof g[1] == "number" && (_ = g[1]), `//${h}/m/${b}x${_}${n} ${b}w`;
            }
          }).join(", "),
...
class ae {
  ...
  async getAll(e, t, r, s) {
    const i = (t == null ? void 0 : t.per_page) || 25, n = `/${e}`.replace(/\/$/, ""), l = r ?? n.substring(n.lastIndexOf("/") + 1), a = 1, h = await this.makeRequest(
      ...
      (d) => this.makeRequest(n, t, i, d + 1, s)
    );
    return this.helpers.flatMap(
      [h, ...f],
      (d) => Object.values(d.data[l])
    );
  }
  post(e, t, r) {
    const s = `/${e}`;
