...
const v = (c = "") => c.includes("/cdn/"), S = (c, e = 25, t = 1) => ({
  ...c,
  per_page: e,
  page: t
...
class V {
  ...
  constructor(e, t) {
    ...
    let r = 5;
    e.oauthToken && (s.set("Authorization", e.oauthToken), r = 3), e.rateLimit && (r = e.rateLimit), this.maxRetries = e.maxRetries || 10, this.retriesDelay = 300, this.throttle = P(
  ...
  async getAll(e, t = {}, i, s) {
    ...
    const l = 1, a = await this.makeRequest(
      ...
      l,
      s
    ), h = a.total ? Math.ceil(a.total / (a.perPage || r)) : 1, d = await L(
      $(l, h),
