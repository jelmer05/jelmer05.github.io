...
var o = (e, r, t) => g(e, typeof r != "symbol" ? r + "" : r, t);
class p {
  constructor() {
    o(this, "isCDNUrl", (r = "") => r.includes("/cdn/"));
    o(this, "getOptionsPage", (r, t = 25, n = 1) => ({
      ...r,
      per_page: t,
      page: n
    }));
    o(this, "delay", (r) => new Promise((t) => setTimeout(t, r)));
    o(this, "arrayFrom", (r = 0, t) => Array.from({ length: r }, t));
    o(this, "range", (r = 0, t = r) => {
      const n = Math.abs(t - r) || 0, s = r < t ? 1 : -1;
      return this.arrayFrom(n, (c, a) => a * s + r);
    });
    o(this, "asyncMap", async (r, t) => Promise.all(r.map(t)));
    o(this, "flatMap", (r = [], t) => r.map(t).reduce((n, s) => [...n, ...s], []));
    /**
     * @method escapeHTML
     * @param  {string} string text to be parsed
     * @return {string} Text parsed
     */
    o(this, "escapeHTML", function(r) {
      const t = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
      ...
      return r && s.test(r) ? r.replace(n, (c) => t[c]) : r;
    });
  }
  /**
   * @method stringify
  ...
  stringify(r, t, n) {
    ...
    for (const c in r) {
      ...
      if (a == null)
        continue;
      const l = n ? "" : encodeURIComponent(c);
      let u;
      typeof a == "object" ? u = this.stringify(
        a,
        t ? t + encodeURIComponent(`[${l}]`) : l,
        Array.isArray(a)
      ) : u = `${t ? t + encodeURIComponent(`[${l}]`) : l}=${encodeURIComponent(a)}`, s.push(u);
    }
    return s.join("&");
  }
  /**
   ...
   */
  getRegionURL(r) {
    const t = "api.storyblok.com", n = "api-us.storyblok.com", s = "app.storyblokchina.cn", c = "api-ap.storyblok.com", a = "api-ca.storyblok.com";
    switch (r) {
      case "us":
        return n;
      case "cn":
