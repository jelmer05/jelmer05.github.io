 ...
 * @license MIT
 */
import { _ as formatMultilineUnion, b as ts, c as appendExtensionListToPattern, f as joinPath, g as warn, h as throttle, i as resolveOptions, l as asRoutePath, m as mergeRouteRecordOverride, o as ESCAPED_TRAILING_SLASH_RE, p as logTree, r as mergeAllExtensions, s as ImportsMap, v as pad, y as toStringLiteral } from "./options-DuVYtToA.mjs";
...
function collectDuplicatedRouteNodes(tree) {
	...
	return Array.from(seen.values().filter((nodes) => Object.keys(nodes).length > 1).map((nodes) => nodes.toSorted(({ node: a }, { node: b }) => {
